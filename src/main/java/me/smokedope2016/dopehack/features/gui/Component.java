...
import me.smokedope2016.dopehack.features.gui.items.buttons.Button;
...
import me.smokedope2016.dopehack.util.render.ScissorUtil;
...
public class Component
    ...
    public void drawScreen(DrawContext context, int mouseX, int mouseY, float partialTicks) {
        ...
        drawString(this.getName(), (float) this.x + 3.0f, (float) this.y - 4.0f - (float) DopeHackGui.getClickGui().getTextOffset(), -1);
    ...
    public void mouseClicked(int mouseX, int mouseY, int mouseButton) {
        if (mouseButton == 0 && this.isHovering(mouseX, mouseY)) {
            ...
            DopeHackGui.getClickGui().getComponents().forEach(component -> {
                if (component.drag) {
