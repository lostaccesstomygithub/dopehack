package me.smokedope2016.dopehack.features.modules;
...
import me.smokedope2016.dopehack.manager.ConfigManager;
...
public class Module extends Feature implements Jsonable {
    ...
    public void setDisplayName(String name) {
        Module module = DopeHack.moduleManager.getModuleByDisplayName(name);
        Module originalModule = DopeHack.moduleManager.getModuleByName(name);
