...
public class ModuleCommand
    ...
    public void execute(String[] commands) {
        ...
        if (commands.length == 1) {
            ...
            for (Module.Category category : DopeHack.moduleManager.getCategories()) {
                String modules = category.getName() + ": ";
                for (Module module1 : DopeHack.moduleManager.getModulesByCategory(category)) {
        ...
        Module module = DopeHack.moduleManager.getModuleByDisplayName(commands[0]);
        if (module == null) {
            module = DopeHack.moduleManager.getModuleByName(commands[0]);
            if (module == null) {
